This project is a backend API for an e-commerce platform built using Go programming language. It provides functionalities to support various operations required for managing an online store.
Features
